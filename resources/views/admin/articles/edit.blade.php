    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.articles.update", [$article->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" name="excerpt" id="excerpt">{{ old('excerpt', $article->excerpt) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('visibility') ? 'is-invalid' : '' }}" name="visibility" id="visibility">
                    ...
                    @foreach(App\Article::VISIBILITY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('visibility', $article->visibility) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
